...
export type { IHistoryDomain } from "./history/ihistory.domain"
export type { HistoryFilter, HistorySimpleDTO, HistoryForm, History } from "./history/history"
export type { CharacterFilter } from "./character/character"
export type { ICharacterDomain } from "./character/icharacter,domain"
export type { IAChats, IAResponseDTO, UserPetition } from "./ia/ia"
export type { IIADomain } from "./ia/ia.domain"